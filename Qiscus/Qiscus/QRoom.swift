...
public class QRoom:Object {
    ...
    // MARK: - room service delegate
    public func roomService(didFailSync json: JSON) {
        
    }
    public func roomService(didFinishSync json: JSON) {
        self.delegate?.room(didFinishSync: self)
    }
}
